...
export declare const keycloak: () => JSX.Element;
export declare const linkedin: () => JSX.Element;
export declare const notion: () => JSX.Element;
export declare const slack: () => JSX.Element;
export declare const spotify: () => JSX.Element;
export declare const twitch: () => JSX.Element;
export declare const workos: () => JSX.Element;
